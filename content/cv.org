...
- Required to work on many different products both customer facing as well as internal tooling.
- Due to my adaptability and ability to get up to speed quickly, I moved between a number of teams within the Engineering department. Often the only developer working on frontend related tasks.
- Sought after by the teams I had previously worked with. I was able to rekindle existing relationships which resulted in faster ramp up times for new initiatives or projects.
- Provided developer as well as operations responsibilities depending on the team I was with. This included answering support questions as well as on-call duties. 
- Successfully conceptualized & deployed a number of solutions from loose business requirements, often under tight timelines.
- Successfully executed a number of projects from start to finish. This included: bootstrapping new micro-frontend frameworks for existing systems, decoupling internal systems from larger code bases to allow for faster development cycles as well as many new features to existing products.
