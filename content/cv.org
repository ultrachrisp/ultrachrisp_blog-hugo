...
- Responsible for developing & deploying internal facing applications to support various MessageBird teams.
- Successfully conceptualised & deployed solutions from business requirements, leveraging existing backend capabilities.
