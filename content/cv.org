...
- Responsible for designing, developing and deploying internal facing user interfaces to support various MessageBird teams.
- Successfully conceptualised and deployed a solution between loose business requirements and existing backend capabilities.
- Successfully decoupled an internal capability from a larger codebase to allow for faster development iterations.
- Responsible for developing robust, flexible and user friendly solutions.
